...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 06 nov. 2018 à 19:18
...
INSERT INTO `event` (`id`, `master_id`, `event_type_id`, `round_id`, `name`, `description`, `game`, `style`, `slots`, `local_start`, `local_end`, `tag`) VALUES
...
INSERT INTO `event_type` (`id`, `name`, `slug`, `tag`) VALUES
(1, 'roleplay', '', ''),
(2, 'wargame', '', ''),
(3, 'boardgame', '', ''),
...
INSERT INTO `round` (`id`, `event_type_id`, `code`, `name`, `start`, `end`, `slug`) VALUES
...
(1, 'Basch', 'Cedric', 'Molines', 'ced_46000@hotmail.com', '$2y$13$O20BMdGs2..CA0XZtVVKXuCvUrPCXkpDLiteLAZ6z9IvGCzX/Z4cq', '$2y$13$jcwH7Jb8mzevk3VR8XMisO/qEqd/pmOtDac9K9gQscTiDV2zcmyi2', 1, 0, '2018-04-16 20:45:00', '2018-04-16 20:45:00', 'a:2:{i:0;s:10:\"ROLE_ADMIN\";i:1;s:8:\"ROLE_JDR\";}', 'nope'),
(2, 'Jdr', 'Admin', 'JDR', 'admin.jdr@example.com', '$2y$13$O20BMdGs2..CA0XZtVVKXuCvUrPCXkpDLiteLAZ6z9IvGCzX/Z4cq', '$2y$13$R6aJlPR8cLPNzMP6NNr4q.6Q3HLikoAjrf7IdCXjzj/CYTNmL0LrK', 1, 0, '2018-04-16 21:19:00', '2018-04-16 21:19:00', 'a:2:{i:0;s:9:\"ROLE_USER\";i:1;s:8:\"ROLE_JDR\";}', 'nope'),
...
(14, 4, 'Liste des parties', 'boardgame', NULL, 1, 1, '', '', '', 1),
